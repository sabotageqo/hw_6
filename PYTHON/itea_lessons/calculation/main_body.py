from input_var import B
from operation import C
from help_for_use import D
        ...
        while loop:
            ...
            try:
                ...
                if response == 1:
                    try:
                        res = None
                        input_some_var = B.var_input()
                        res = C.OPERATION[input_some_var["operation"]](input_some_var["first_var"], input_some_var["second_var"])
                        print("Ответ: ", res)
                        print()
                    ...
                    print(D.help_in_proggram.__doc__)
                elif response == 3:
